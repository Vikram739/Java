/*
    It,s a project for employee
    management system using array.


    #Develop By: Markali Vikram
    #SYIT[G3]
    #GP AWASARI [KH]
*/
	...
	public static void main(String[] args)
	{
		...
		do
		{
			...
			case 1:System.out.println("\nEnter the following details to ADD list:\n");
				...
				//display(al);
				System.out.println("\n\n Employee Details Added succsessfully!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
				break;
			...
			case 3: System.out.println("\nEnter the Employee ID to EDIT the details");
					...
					for(Employee e: al)
					{
						...
						do{
							...
							default : System.out.println("\nEnter a correct choice from above List :");
										break;
			...
			case 4: System.out.println("\nEnter Employee ID to DELETE from the Databse :");
					...
					for(Employee e: al)
					{
						if(id == e.id)
						{
								al.remove(e);
								//display(al);
								System.out.println("\n\n Employee Details Deleted succsessfully!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
								k++;
						}
					}
					if(k == 0)
			...
			case 5: try {
					...
					if(res==true)
        				{
						System.out.println("Sorry, Employee list is already empty");
                                        }
					else
					{
						display(al);
